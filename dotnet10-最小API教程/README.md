...
面向新手的图文并茂教程，从零基础到进阶实战，覆盖 .NET 10 最小 API（Minimal API）的方方面面。全书 **5 部分 21 章 + 4 附录**，含大量可运行代码示例与 34 张示意图。
...
**第一部分 入门与原理**：1 认识最小 API · 2 运行原理与请求处理管线 · 3 环境搭建与第一个程序 · 4 在 Windows 服务器上部署、运行与管理最小 API
**第二部分 核心功能**：5 路由 · 6 参数绑定 · 7 返回结果 · 8 依赖注入
**第三部分 数据与校验**：9 请求校验（.NET 10 新特性）· 10 EF Core
**第四部分 文档/安全/实时**：11 OpenAPI（.NET 10 新特性）· 12 认证与授权 · 13 端点过滤器与中间件 · 14 SSE（.NET 10 新特性）
**第五部分 工程化与进阶**：15 配置日志 · 16 CORS/限流/健康检查 · 17 版本控制 · 18 测试 · 19 组织大型项目 · 20 部署与性能 · 21 综合实战
