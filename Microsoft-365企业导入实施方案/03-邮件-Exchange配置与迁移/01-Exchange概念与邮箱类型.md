...
| “买了 Office 就有邮箱” | 要看许可证是否包含 Exchange Online；**本方案的 E3 包含**（第1篇 1.26.1） |
...
| 扩容 | 要提升到 **100 GB**，需给该共享邮箱**分配一个 E3 许可**（E3 含 Exchange Online Plan 2） |
| 在线存档 | 同上，分配 E3 许可即可启用并扩大存档 |
| 诉讼保留 | 同上，分配 E3 许可即可 |
...
- [ ] 已知悉共享邮箱的规则：无许可 50 GB 上限、**扩容需分配一个 E3 许可**、25 名用户限制、**必须阻止登录**。
