...
| 误解 | 事实 |
|---|---|
| “Microsoft 365 = 网页版 Office” | **本方案的 E3 包含桌面版**安装权利（第1篇 1.26.1） |
...
| Visio / Project | ❌ **E3 不含，需单独许可** | 需确认是否已采购；未采购则不要装 |
...
| 前提 | 需要在部署配置中启用该模式；**许可方面 E3 已支持**（第1篇 1.26.1），无需额外采购 |
...
- 部署方式与激活要求与普通电脑不同。
- 本方案的 **E3 支持共享电脑激活**（4.10.2），这是虚拟桌面场景的关键前提；**具体虚拟化使用条款仍应与供应商书面确认**（第1篇 1.27.4 第 8 问）。
- 需要与虚拟桌面平台的管理员共同规划。
