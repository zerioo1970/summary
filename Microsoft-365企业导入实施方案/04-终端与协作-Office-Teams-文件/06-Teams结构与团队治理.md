...
> **本方案的 Teams 许可来源（务必先确认）：** 本项目为**净新订阅**，Teams **不随 Microsoft 365 E3 提供**，而是来自单独购买的 **Microsoft Teams Enterprise** 许可（第1篇 1.26.3）。开始本节之前，请确认目标用户**同时**拥有 E3 与 Teams Enterprise 两个许可——否则用户能用 Office 和邮箱，但 Teams 登录会失败。另外，**Teams Premium 的增强能力（水印、高级会议保护）本方案不采购**（第1篇 1.26.5）。
